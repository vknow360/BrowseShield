...
import { validateOutboundPayload, privacyGate } from '../src/core/tokenizer/privacy-gate.js';
...
describe('Privacy Gate (validateOutboundPayload)', () => {
  ...
  it('blocks payload if structured data (Aadhaar) leaks', () => {
    ...
    const payload = JSON.stringify({ nodes: [{ value: '[[AADHAAR_1]]' }, { value: '1234 5678 9012' }] });
    const tokenMap = {
      '[[AADHAAR_1]]': { realValue: '1234 5678 9012', entityType: 'AADHAAR' }
    };
...
describe('Privacy Gate (enforcement wrapper)', () => {
  ...
  it('respects enforcement mode', () => {
    ...
    const map = { '[[VALUE_1]]': { realValue: 'Secret', entityType: 'MEDICAL' } };
